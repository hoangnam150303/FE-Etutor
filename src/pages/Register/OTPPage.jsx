            ...
            <Form>
              <div className="mb-4">
                ...
                <div className="h-0.5">
                  ...
                  />
                  {otpError && (
                    <div className="text-red-500 text-sm ml-0.5">
                      {otpError}
                    </div>
                  )}
                </div>
              ...
              <button
                type="submit"
                className={`w-full my-3 p-2 bg-blue-500 text-white font-semibold rounded-md hover:bg-blue-600 transition duration-300 ${
