...
const validationSchema = yup.object().shape({
    ...
    avatar: yup.string().url("Avatar must be a valid URL").required("Avatar URL is required"),
});
        ...
        <div>
            <Content className='mx-2 my-7 lg:mx-5'>
                ...
                <div className="active-button flex justify-between items-center">
                    ...
                    />
                    <Button className="text-green-800 px-4 py-1 rounded-md border border-green-800" onClick={showModal}>
                        Create Tutor
                    </Button>
                    <Modal title="New Tutor" open={isModalOpen} onCancel={handleCancel} footer={null}>
                        <Formik
                            initialValues={{ username: "", email: "", password: "", phoneNumber: "", avatar: "" }}
                            ...
                            {({ isSubmitting }) => (
                                <Form className="flex flex-col gap-4">
                                    <div>
                                        ...
                                        <Field as={Input} name="username" type="text" className="border p-2 w-full" />
                                    ...
                                    <div>
                                        ...
                                        <Field as={Input} name="email" type="email" className="border p-2 w-full" />
                                        <div className="div-error h-2">
                                    ...
                                    <div>
                                        ...
                                        <Field as={Input} name="password" type="password" className="border p-2 w-full" />
                                        <div className="div-error h-2">
                                    ...
                                    <div>
                                        ...
                                        <Field as={Input} name="phoneNumber" type="text" className="border p-2 w-full" />
                                        <div className="div-error h-2">
                                    ...
                                    <div className="flex justify-end gap-2">
                                        ...
                                        <Button type="primary" htmlType="submit" disabled={isSubmitting} className="bg-blue-500 text-white px-4 py-2 rounded-md">
