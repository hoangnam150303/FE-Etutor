...
const experience = [
  {
    ...
    image:
      "https://res.cloudinary.com/dnv7bjvth/image/upload/v1743668836/review-1_emx5ps.webp",
  },
  {
    id: 2,
    name: "Nguyễn Thị Mai",
    ...
    image:
      "https://res.cloudinary.com/dnv7bjvth/image/upload/v1743668837/review-2_rbrmkp.webp", // Thay bằng ảnh thực tế
  },
  {
    id: 3,
    name: "Trần Thị Nga",
    ...
    image:
      "https://res.cloudinary.com/dnv7bjvth/image/upload/v1743668837/review-3_zb5evl.webp", // Thay bằng ảnh thực tế
  },
];
      ...
      <div className="container mx-auto text-center">
        ...
        >
          {experience.map((experience) => (
            <div key={experience.id} className="select-none cursor-pointer">
