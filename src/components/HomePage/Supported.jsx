...
const supported = [
  {
    ...
    image:
      "https://res.cloudinary.com/dnv7bjvth/image/upload/v1743668835/BasicQualifications_ahbqpf.webp",
  },
  {
    id: 2,
    ...
    image:
      "https://res.cloudinary.com/dnv7bjvth/image/upload/v1743668834/AdvancedQualifications_zvwxaf.webp",
  },
];
    ...
    <div className=" container mx-auto">
      <div className="mb-20 sm:mb-4 xl:mb-20">
        <h2 className="text-center text-xl sm:text-xl lg:text-4xl font-bold mb-6">
          ĐỐI TƯỢNG HỌC VIÊN MÀ CHÚNG TÔI ĐANG TẬP TRUNG HỖ TRỢ
        </h2>
        <div className="w-full sm:w-full h-96 mx-auto grid grid-cols-1 sm:grid-cols-2 gap-2 justify-center">
          {supported.map((support) => (
            <div
              key={support.id}
              className="p-6 bg-white rounded-md flex flex-col items-center justify-center"
            >
